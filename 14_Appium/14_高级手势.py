...
wlanEl = dr.find_element(By.XPATH, "//*[@text='WLAN']")
ac = ActionChains(dr)
# 单击操作
ac.w3c_actions.pointer_action.click(wlanEl)
ac.perform()

findParams = By.XPATH, "//*[@text='已连接']"
connEl = Tools.getElement(dr, findParams)

 # 按下和抬起
ac.w3c_actions.pointer_action.click_and_hold(connEl).pause(2).release()
ac.perform()
